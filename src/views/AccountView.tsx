  ...
  return (
    <div className="space-y-4 pb-20">
      ...
      <div className="space-y-2">
        ...
        {/* Security 2FA */}
        <div className="p-3.5 rounded-xl bg-[#08101D] border border-[#14233A] flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                <span className="font-bold text-xs text-white">Google 2FA Authenticator</span>
                <span className="px-1.5 py-0.2 rounded text-[10px] font-mono bg-emerald-500/10 text-emerald-400">
                  Aktif
                </span>
              </div>
              <p className="text-[10px] text-slate-400 font-mono mt-0.5">
                Proteksi penarikan vault dan transfer P2P
              </p>
            </div>
          </div>
